...
@Component({
  selector: 'MediaAppearance-home',
  templateUrl: './MediaAppearance-home.component.html',
  styleUrls: ['./MediaAppearance-home.component.scss']
})
export class MediaAppearanceHomeComponent implements AfterViewInit {
