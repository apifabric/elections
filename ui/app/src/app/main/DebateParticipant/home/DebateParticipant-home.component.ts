...
@Component({
  selector: 'DebateParticipant-home',
  templateUrl: './DebateParticipant-home.component.html',
  styleUrls: ['./DebateParticipant-home.component.scss']
})
export class DebateParticipantHomeComponent implements AfterViewInit {
