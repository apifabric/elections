...
@Component({
  selector: 'ElectionResult-home',
  templateUrl: './ElectionResult-home.component.html',
  styleUrls: ['./ElectionResult-home.component.scss']
})
export class ElectionResultHomeComponent implements AfterViewInit {
