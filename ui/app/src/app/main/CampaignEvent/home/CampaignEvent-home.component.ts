...
@Component({
  selector: 'CampaignEvent-home',
  templateUrl: './CampaignEvent-home.component.html',
  styleUrls: ['./CampaignEvent-home.component.scss']
})
export class CampaignEventHomeComponent implements AfterViewInit {
