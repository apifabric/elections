...
@Component({
  selector: 'Debate-home',
  templateUrl: './Debate-home.component.html',
  styleUrls: ['./Debate-home.component.scss']
})
export class DebateHomeComponent implements AfterViewInit {
